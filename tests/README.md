...
| **Integration(运行时)** | `examples/hello` spike(67 项确定性,含 2 项 key-window bonus;EXIT 0)                          | 真实 host+webview 端到端;tjs:` 模块 / 网络 / 会退出应用的命令                      | 手动 `pnpm --filter @ztron/example-hello dev` |
