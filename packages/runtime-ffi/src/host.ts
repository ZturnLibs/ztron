...
export class HostRuntime implements RuntimeAdapter {
  ...
  #nextReqId = 1;
  #trayEventCb: ((event: import("@ztron/core").TrayEventPayload) => void) | null =
    null;
  ...
  readonly menu: MenuController = {
    ...
    items: async (menuId) => {
      ...
      return Array.isArray(r)
        ? (r as import("@ztron/core").MenuItemsSnapshot)
        : [];
    },
  ...
  #onLine(line: string): void {
    ...
    switch (msg.type) {
      ...
      case "tray_event": {
        const ev = msg as unknown as import("@ztron/core").TrayEventPayload;
        this.#trayEventCb?.(ev);
        break;
      }
      case "menu_event": {
